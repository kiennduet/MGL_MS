...
# Đường dẫn file TSV
file_path = '/media/avitech/MyPassport/Kien/MEG_data/updated_participants.tsv'  # Thay bằng đường dẫn của bạn
...
sns.histplot(filtered_data['age'], bins=10, kde=True, color='skyblue', label='Age Distribution')

# Thêm thông tin vào biểu đồ
plt.title('Age Distribution of Selected Participants', fontsize=16)
