...
from side_function import search_files, get_subject_list, search_files_v2
...
dir_meg,_ = search_files_v2(directory=path_meg, file_type='.fif', sub_name=sub_nums, title="Raw MEG files matched")
